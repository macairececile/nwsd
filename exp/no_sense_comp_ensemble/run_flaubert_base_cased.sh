...
#SBATCH --job-name=flaubert_base_cased_ensemble
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=flaubert_base_cased_ensemble
...
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/flaubert_base_cased_ensemble # to store the trained model
