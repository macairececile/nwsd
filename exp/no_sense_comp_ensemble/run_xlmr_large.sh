...
#SBATCH --job-name=xlmr_large_ensemble
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=xlmr_large_ensemble
...
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/xlmr_large_ensemble # to store the trained model
