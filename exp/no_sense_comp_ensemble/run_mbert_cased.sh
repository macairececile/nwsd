...
#SBATCH --job-name=mbert_cased_ensemble
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=mbert_cased_ensemble
...
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/mbert_cased_ensemble # to store the trained model
