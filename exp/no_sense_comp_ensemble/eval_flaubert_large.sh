...
#SBATCH --job-name=flaubert_large_eval
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=flaubert_large_eval
...
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/flaubert_large_ensemble # to store the trained model
...
--weights $TARGET_DIRECTORY/model_weights_wsd1 \
--corpus $TEST_DATA \
--lowercase True \
