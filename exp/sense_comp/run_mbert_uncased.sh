...
#SBATCH --job-name=mbert_uncased_sense_comp
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=mbert_uncased_sense_comp
...
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/mbert_uncased_sense_comp # to store the trained model
TXT_TO_WSD=/gpfswork/rech/czj/uef37or/nwsd/data/to_disambiguate
WEIGHTS_PATH=/gpfsscratch/rech/czj/uef37or/wsd/mbert_uncased_sense_comp/model_weights_wsd0
