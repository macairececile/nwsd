...
#SBATCH --job-name=flaubert_base_uncased_sense_comp
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=flaubert_base_uncased_sense_comp
...
BERT_PATH=/gpfsstore/rech/czj/uef37or/pretrained_models/flaubert-base-uncased
...
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/flaubert_base_uncased_sense_comp # to store the trained model
TXT_TO_WSD=/gpfswork/rech/czj/uef37or/nwsd/data/to_disambiguate
WEIGHTS_PATH=/gpfsscratch/rech/czj/uef37or/wsd/flaubert_base_uncased_sense_comp/model_weights_wsd0
