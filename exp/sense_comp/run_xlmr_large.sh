...
#SBATCH --job-name=xlmr_large_sense_comp
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=xlmr_large_sense_comp
...
BERT_PATH=/gpfsstore/rech/czj/uef37or/pretrained_models/xlm-roberta-large
TEST_DATA=/gpfswork/rech/czj/uef37or/nwsd/data/corpora/semeval2013task12.fr.xml
DATA_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/data_sense_comp # to store the prepared data
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/xlmr_large_sense_comp # to store the trained model
TXT_TO_WSD=/gpfswork/rech/czj/uef37or/nwsd/data/to_disambiguate
WEIGHTS_PATH=/gpfsscratch/rech/czj/uef37or/wsd/xlmr_large_sense_comp/model_weights_wsd0
...
# --input_auto_model xlm-roberta --input_auto_path $BERT_PATH \
