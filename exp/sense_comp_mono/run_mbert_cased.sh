...
#SBATCH --job-name=mbert_cased_sense_comp_mono
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=mbert_cased_sense_comp_mono
...
TARGET_DIRECTORY=/gpfsscratch/rech/czj/uef37or/wsd/mbert_cased_sense_comp_mono # to store the trained model
TXT_TO_WSD=/gpfswork/rech/czj/uef37or/nwsd/data/to_disambiguate
WEIGHTS_PATH=/gpfsscratch/rech/czj/uef37or/wsd/mbert_cased_sense_comp_mono/model_weights_wsd0
