...
import torch
from loss.label_smoothed_cross_entropy import LabelSmoothedCrossEntropyCriterion
from modules.embeddings.embeddings_lut import EmbeddingsLUT
from modules.decoders.decoder_classify import DecoderClassify
from modules.decoders.decoder_translate_transformer import DecoderTranslateTransformer
from optim.scheduler_noam import SchedulerNoam
...
from modules.embeddings.embeddings_auto import get_auto_embeddings
from modules.embeddings.embeddings_bert import get_bert_embeddings
from modules.embeddings.embeddings_elmo import get_elmo_embeddings
from modules.encoders.encoder_base import EncoderBase
from modules.encoders.encoder_lstm import EncoderLSTM
from modules.encoders.encoder_transformer import EncoderTransformer
from optim.scheduler_fixed import SchedulerFixed
...
class Model(object):
    ...
    def load_model_weights(self, file_path, hf=None):
        save = torch.load(file_path, map_location=str(default_device))
        if hf:
            self.config.load_from_serializable_data(save["config"], hf)
        else:
...
class TorchModel(Module):
    ...
    def __init__(self, config: ModelConfig, data_config: DataConfig):
        ...
        # config.input_auto_path[0] = "/home/cecilemacaire/Bureau/demo/camembert-base"
        #config.input_auto_path[0] = "/home/getalp/macairec/models/pretrained_models/camembert-large"
        # config.input_auto_path[0] = "/home/getalp/macairec/models/pretrained_models/bert-base-multilingual-uncased"
        # config.input_auto_path[0] = "/home/getalp/macairec/models/pretrained_models/bert-base-multilingual-cased"
        # config.input_auto_path[0] = "/home/getalp/macairec/models/pretrained_models/flaubert_large_cased"
        # config.input_auto_path[0] = "/home/getalp/macairec/models/pretrained_models/xlm-roberta-base"
        # config.input_auto_path[0] = "/home/getalp/macairec/models/pretrained_models/xlm-roberta-large"
