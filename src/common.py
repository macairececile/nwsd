...
from torch_utils import cpu_device
...
def read_samples_from_file(file_path: str, input_clear_text: List[bool], output_features: int, output_translations: int,
                           output_translation_features: int, output_translation_clear_text: bool, limit: int = -1):
...
def read_batch_from_samples(samples, batch_size: int, token_per_batch: int, current_index: int, input_features: int,
                            output_features: int, output_translations: int, output_translation_features: int,
                            input_clear_text: List[bool], output_translation_clear_text: bool):
...
def save_training_info(file_path, current_ensemble, current_epoch, current_batch, current_batch_total, train_line,
                       current_best_loss, current_best_wsd, current_best_bleu, random_seed):
